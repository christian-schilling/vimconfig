...
syn match Constant /[A-Z_][A-Z0-9_]*[A-Z0-9_]/
syn match Type /[A-Z][a-zA-Z0-9]*[a-z0-9]/
syn match Identifier /__[a-zA-Z0-9_]*__/
syn keyword Constant True
syn keyword Constant False
syn keyword Constant None
syn keyword Constant self
